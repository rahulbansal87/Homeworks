...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["Chocolate", "More Chocolate", "Even More Chocolate", "Way More Chocolate"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Ray the Great Baker")
      expect(dessert.serve).to include("Ray")
    end
  end
